...
from staketaxcsv.settings_csv import (
    ...
    TICKER_OSMO, TICKER_REGEN, TICKER_ROWAN, TICKER_SCRT, TICKER_SOL, TICKER_STARS, TICKER_TORI, TICKER_XPRT, TICKER_STRD)
...
import staketaxcsv.report_xprt
...
REPORT_MODULES = {
    ...
    TICKER_XPRT: staketaxcsv.report_xprt,
